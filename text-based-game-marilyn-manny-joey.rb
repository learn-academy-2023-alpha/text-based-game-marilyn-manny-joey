...
def knife
    File.readlines('knife.txt') do |line|
    puts line
    end
end
def phone
        File.readlines('phone.txt') do |line|
        puts line
        end
end
def boots
            File.readlines('boots.txt') do |line|
            puts line
            end
end
def glove
    File.readlines('glove.txt') do |line|
    puts line
    end
end
...
def solve name
    ...
    p "Choose who you think killed Frank: 'dan', 'chad' or 'Amazon driver'"
    p "...................................."
    input_solve = gets.chomp
    if input_solve == "dan"
        p "Dr. Dan wanted a way to be with Dr. Jane, but unfortunately he is not the murderer. Better luck next time #{name}, the murderer has gotten away."
        p "...................................."
    elsif input_solve == "chad"
        p "Chad found Frank dead outside, but he was not the murderer. His pocket knife just fell out of his pocket when he ran over to help him. Better luck next time #{name}, the murderer has gotten away."  
    elsif  input_solve == "Amazon driver"
       p "...................................."
